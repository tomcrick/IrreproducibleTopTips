...
\author[1]{Tom Crick}
\author[2]{Ian P. Gent}
\author[3]{Neil P. Chue Hong}
\author[4]{Lars Kotthoff}
% institutions
\affil[1]{Department of Computing \& Information Systems, Cardiff
  Metropolitan University, UK}
  \affil[2]{School of Computer Science, University of St Andrews, UK}
  \affil[3]{Software Sustainability Institute, UK}
\affil[4]{Insight Centre for Data Analytics, University College Cork,
  Ireland}
% emails
\affil[1]{\protect\url{tcrick@cardiffmet.ac.uk}}
\affil[2]{\protect\url{ian.gent@st-andrews.ac.uk}}
\affil[3]{\protect\url{N.ChueHong@software.ac.uk}}
