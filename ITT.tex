...
\affil[4]{Insight Centre for Data Analytics, University College Cork,
  Ireland}
% emails
\affil[1]{\url{http://www2.epcc.ed.ac.uk/\~neilc/} ~~~~  \protect\url{N.ChueHong@software.ac.uk}}
\affil[2]{\url{http://drtomcrick.com/} ~~~~ \protect\url{tcrick@cardiffmet.ac.uk}}
\affil[3]{\protect\url{http://ian.gent} ~~~~ \protect\url{ian.gent@st-andrews.ac.uk}}
\affil[4]{\url{http://4c.ucc.ie/\~larsko/} ~~~~ \protect\url{lars.kotthoff@insight-centre.org}}
...
reproducible~\cite{prlic+procter:2012,sandve-et-al:2013,gent:2013,gent_recomputation.org_2014,wilson-et-al:2014,goble:2014,crick-et-al_wssspe2,crick-et-al_recomp2014,stodden+miguez:2014};
